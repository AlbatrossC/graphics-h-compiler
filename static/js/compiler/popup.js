(function () {
    ...
    function injectStyles() {
        if (document.getElementById('ai-poll-styles')) return;
        const style = document.createElement('style');
        style.id = 'ai-poll-styles';
        style.textContent = `
            #${POPUP_ID} {
                position: fixed;
                right: 20px;
    ...
    function createPopup() {
        ...
        // Clarity: unmask the entire popup so it is visible in session recordings
        wrapper.setAttribute('data-clarity-unmask', 'true');

        wrapper.innerHTML = `
            <div class="ai-poll-card" data-clarity-unmask="true">
                <div class="ai-poll-content" data-clarity-unmask="true">
                    <div class="ai-poll-layout" data-clarity-unmask="true">
                        <div class="ai-poll-main" data-clarity-unmask="true">
                            <div class="ai-poll-topbar">
                                <p class="ai-poll-heading">Quick question for users 👋</p>
                                <button type="button" class="ai-poll-close" id="ai-poll-close-btn" aria-label="Close poll"><span aria-hidden="true">×</span><span>Close</span></button>
                            </div>
                            <p class="ai-poll-question" data-clarity-unmask="true">I'm thinking of adding an AI assistant to this website to help you write and generate your code here. What do you think, should I add this feature?</p>
                    <form class="ai-poll-form" id="ai-poll-form" data-clarity-unmask="true">
                        <div class="ai-poll-options" role="radiogroup" aria-label="AI feature poll" data-clarity-unmask="true">
                            <label class="ai-poll-option" data-clarity-unmask="true">
                                <input type="radio" id="ai-poll-vote-yes" name="ai-poll-vote" value="yes" data-clarity-unmask="true" />
                                <span>Yes, add it</span>
                            </label>
                            <label class="ai-poll-option" data-clarity-unmask="true">
                                <input type="radio" id="ai-poll-vote-no" name="ai-poll-vote" value="no" data-clarity-unmask="true" />
                                <span>No, not needed</span>
                            </label>
                        </div>
                        <textarea
                            id="ai-poll-message-textarea"
                            class="ai-poll-textarea"
                            name="message"
                            data-clarity-unmask="true"
                            placeholder="If you have suggestions for the AI feature, you can write them here (optional)."
                        ></textarea>
                        <div class="ai-poll-footer">
                            <button type="submit" class="ai-poll-submit" id="ai-poll-submit-btn" data-clarity-unmask="true">Submit Vote</button>
